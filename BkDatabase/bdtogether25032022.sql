...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2022 at 06:27 PM
...
--
-- Table structure for table `catchild`
--
...
CREATE TABLE `catchild` (
  ...
  `datocurioso` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Informacion de los estudiantes que necesitan ser patrocinado';
...
--
-- AUTO_INCREMENT for table `catchild`
--
ALTER TABLE `catchild`
